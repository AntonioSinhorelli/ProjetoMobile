...
**Para** saber quais datas e horários as quadras estão vagas para reservas  
...
**E** escolhi a quadra desejada junto com a data e horário  

**Quando** eu clicar em confirmar, o pagamento é exibido  

**Então** eu realizo o pagamento  
